  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6 mt-4 sm:mt-8 space-y-6">
      <div className="flex flex-wrap justify-between items-center gap-2">
        <Link to="/records" className="text-white hover:text-emerald-500 text-sm">← Back to Records</Link>
        <div className="space-x-3">
          <button onClick={() => setIsEditing(!isEditing)} className="text-sm font-semibold text-emerald-500 hover:underline">
